...
firebase = firebase.FirebaseApplication('https://orbital-2020.firebaseio.com/admin-channel')
# To enable logging
import logging
...
def done(update, context):
    ...
    #update/store data on firebase
    result = firebase.put('Users',uid,user_data)
